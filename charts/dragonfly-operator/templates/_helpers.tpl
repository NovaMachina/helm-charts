...
{{- default (printf "%s-%s" (include "dragonfly-operator.fullname" .) "controller-manager-metrics-service" ) .Values.serviceAccount.name }}
{{- else }}
{{- default "dragonfly-operator-controller-manager-metrics-service" .Values.serviceAccount.name }}
{{- end }}
{{- end }}
